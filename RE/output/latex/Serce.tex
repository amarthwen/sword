...
\begin{center}
\textbf{Wersety do studium:} (Ef~3,~14-19), (Ga~4,~6), (Rz~8,~15), (Jr~31,~31-34), (2~Kor~1,~21-22), (2~Kor~3,~3), (1~Kor~2,~9-10), (Jr~17,~9-10), (Oz~5,~4), (Łk~6,~45), (Jk~3,~7-12), (Jk~4,~8), (Ps~51,~12), (Mt~6,~19-21), (Rz~1,~18-25), (1~Moj~6,~5-6)
\end{center}
\begin{quote}
...
\end{quote}
\begin{quote}
,,Podstępne jest serce, bardziej niż wszystko inne, i zepsute, któż może je poznać? Ja, Pan, zgłębiam serce, wystawiam na próbę nerki, aby oddać każdemu według jego postępowania, według owocu jego uczynków.'' (Jr~17,~9-10)
\end{quote}
\begin{quote}
...
\end{quote}
\begin{quote}
,,Bo wszelki rodzaj dzikich zwierząt i ptaków, płazów i stworzeń morskich może być ujarzmiony i został ujarzmiony przez rodzaj ludzki. Natomiast nikt z ludzi nie może ujarzmić języka, tego krnąbrnego zła, pełnego śmiercionośnego jadu. Nim wysławiamy Pana i Ojca i nim przeklinamy ludzi, stworzonych na podobieństwo Z tych samych ust wychodzi błogosławieństwo i przekleństwo. Tak, bracia moi, być nie powinno. Czy źródło wydaje z tego samego otworu wodę słodką i gorzką? Czy drzewo figowe, bracia moi, może rodzić oliwki albo winna latorośl figi? Tak też słony zdrój nie może wydać słodkiej wody.'' (Jk~3,~7-12)
\end{quote}
\begin{quote}
,,Zbliżcie się do Boga, a zbliży się do was. Obmyjcie ręce, grzesznicy, i oczyśćcie serca, ludzie o rozdwojonej duszy.'' (Jk~4,~8)
\end{quote}
\begin{quote}
