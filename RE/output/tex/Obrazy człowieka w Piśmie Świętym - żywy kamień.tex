...
\begin{center}
\textbf{Wersety do studium:} \mbox{(1P 2, 4-9)}, \mbox{(Iz 51, 1)}
\end{center}
...
\paragraph{}
\begin{quote}
,,Słuchajcie mnie, wy, którzy dążycie do sprawiedliwości, wy, którzy szukacie Pana. Spójrzcie na skałę, z której jesteście wyciosani, i na kamieniołom, z którego jesteście wydobyci!'' \mbox{(Iz 51, 1)}
\end{quote}
\end{document}