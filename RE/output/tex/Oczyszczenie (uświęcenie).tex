...
\begin{center}
\textbf{Wersety do studium:} \mbox{(1J 1, 6-10)}, \mbox{(5Moj 32, 43)}, \mbox{(Iz 1, 25-26)}, \mbox{(Iz 1, 16-18)}, \mbox{(Iz 4, 3-4)}, \mbox{(Jr 13, 26-27)}, \mbox{(Jr 6, 27-30)}, \mbox{(Ml 3, 1-4)}, \mbox{(Za 13, 8-9)}, \mbox{(Ez 22, 17-22)}, \mbox{(1J 3, 2-3)}
\end{center}
...
\paragraph{}
\begin{quote}
,,I będzie tak, że kto pozostanie na Syjonie i ostoi się w Jeruzalemie, będzie nazwany świętym; każdy, kto jest zapisany wśród żywych w Jeruzalemie. Gdy Pan zmyje brud córek syjońskich i usunie plamy krwi z Jeruzalemu tchnieniem sądu i tchnieniem zniszczenia,'' \mbox{(Iz 4, 3-4)}
\end{quote}
\paragraph{}
\begin{quote}
